        ...
        for ttype, value in tokensource:
            ...
            if ttype == lasttype:
                ...
                if lastval:
                    ...
                    self.out_content.InsertString( str(lastval.encode("utf-8")) )
...
class PyEditor(Frame, PyEditorBase):
    ...
    def OnCommand(self, command):
        super(PyEditor, self).OnCommand(command)
        
    def ApplySchemeSettings(self, schemeobj):
        super(PyEditor, self).ApplySchemeSettings(schemeobj)
    ...
    def OnMousePressed(self, code):
        super(PyEditor, self).OnMousePressed(code)
