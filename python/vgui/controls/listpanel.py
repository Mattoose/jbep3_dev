...
class ListPanel(Panel):
    ...
    def AddSelectedItem(self, itemID):
        ...
        #assert( !self.selecteditems.HasElement( itemID ) )
    ...
    def PaintBackground(self):
        super(ListPanel, self).PaintBackground()
    ...
    def HandleMultiSelection(self, itemID, row, column):
        ...
        for i in range(startRow, endRow+1):
            ...
            try:
                self.selecteditems.index(selectedItemID)
    ...
    def SortList(self):
        ...
        # sort the list
        self.visibleitems.sort(AscendingSortFunc)
