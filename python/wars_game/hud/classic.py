...
from core.hud import BaseHudAbilities, HudUnitsContainer, BaseHudPortrait, BaseHudInfo, BaseHudMinimap, BaseHudGroups, BaseHudUnits
...
class HudClassic(CHudElement, Panel):
    def __init__(self):
        ...
        self.portraitpanel = self.portraitpanelcls(GetClientMode().GetViewport()) # Needs to be behind us
    ...
    def UpdateOnDelete(self):
        ...
        if self.minimap:
            ...
            self.minimap = None
        if self.portraitpanel:
            self.portraitpanel.DeletePanel()
            self.portraitpanel = None
    ...
    def PerformLayout(self):
        ...
        # Position/Size portrait panel
        self.portraitpanel.SetPos( int(( data['portrait_posx'] / float(tex_width) ) * w), 
            int(( data['portrait_posy'] / float(tex_height) ) * h) + self.screenheight - h )
        self.portraitpanel.SetSize( int(( data['portrait_sizex'] / float(tex_width) )  * w), 
            int(( data['portrait_sizey'] / float(tex_height) ) * h) )
    ...
    def SetVisible(self, state):
        ...
        self.portraitpanel.SetVisible(state)
    ...
    portraitpanelcls = BaseHudPortrait
