from srcbase import *
from vmath import *
from basehelicopter import BaseHelicopter as BaseClass
from core.units import UnitInfo, UnitBaseAirLocomotion, EventHandlerAnimation
...
# Animstate
class UnitBaseGunshipAnimState(UnitBaseAnimState):
    def __init__(self, outer, *args, **kwargs):
        super(UnitBaseGunshipAnimState, self).__init__(outer)
...
class UnitCombineGunship(BaseClass):    
    """ Combine Gunship """
    def __init__(self):
        super(UnitCombineGunship, self).__init__()
    ...
    if isserver:
        def Precache(self):
            super(UnitCombineGunship, self).Precache()
    ...
    def Spawn(self):
        super(UnitCombineGunship, self).Spawn()
        ...
        self.locomotion.desiredheight = 350.0
        self.locomotion.flynoiserate = 48.0
        self.locomotion.flynoisez = 24.0

    def UnitThink(self):
        super(UnitCombineGunship, self).UnitThink()
    ...
    def InitializeRotorSound(self):
        ...
        super(UnitCombineGunship, self).InitializeRotorSound()
    ...
    def StopLoopingSounds(self):
        ...
        super(UnitCombineGunship, self).StopLoopingSounds()
    ...
    def FireCannonRound(self):
        ...
        if self.IsTargettingMissile():
            ...
            #info.m_flPlayerDamage = pAmmoDef.PlrDamage( self.ammotype )
    ...
    def MakeTracer(self, vecTracerSrc, tr, iTracerType):
        if iTracerType == TRACER_LINE:
            ...
            super(UnitCombineGunship, self).MakeTracer( vecTracerSrc, tr, iTracerType )

    def DoMuzzleFlash(self):
        super(UnitCombineGunship, self).DoMuzzleFlash()
