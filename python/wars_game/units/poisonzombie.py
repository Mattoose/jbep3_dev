...
class UnitPoisonZombie(BaseClass):
    if isserver:
        def Precache(self):
            ...
            super(UnitPoisonZombie, self).Precache() 
            
        def Spawn(self):
            super(UnitPoisonZombie, self).Spawn()
    ...
    def Event_Killed(self, info):
        ...
        super(UnitPoisonZombie, self).Event_Killed(info)
...
class PoisonZombieInfo(BaseZombieInfo):
    ...
    class AttackRange(BaseZombieInfo.AttackRange):
        ...
        def Attack(self, unit, enemy): 
            ...
            return super(PoisonZombieInfo.AttackRange, self).Attack(unit, enemy)
