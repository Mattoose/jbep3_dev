...
class AbilityBurrow(AbilityBase):
    # Info
    name = "burrow"
    image_name = 'vgui/abilities/ability_burrow_down.vmt'
    rechargetime = 1
...
class AbilityUnBurrow(AbilityBase):
    # Info
    name = "unburrow"
    image_name = 'vgui/abilities/ability_burrow_up.vmt'
    rechargetime = 1
    ...
    # Ability Code
    def Init(self):
        super(AbilityUnBurrow, self).Init()
