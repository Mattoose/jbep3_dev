...
if isserver:
    ...
    class NetworkVar(NetworkVarInternal):
        def __init__(self, ent, name, data, changedcallback=None):
            super(NetworkVar, self).__init__(ent, name, data, changedcallback=bool(changedcallback))
    ...
    class NetworkArray(NetworkArrayInternal):
        def __init__(self, ent, name, data=None, changedcallback=None):
            if not data: data = list()
            super(NetworkArray, self).__init__(ent, name, data)
    ...
    class NetworkDict(NetworkDictInternal):
        def __init__(self, ent, name, data=None, changedcallback=None):
            ...
            super(NetworkDict, self).__init__(ent, name, data)
            setattr(ent, name, self)
            self.data = data
    ...
    class NetworkDefaultDict(NetworkDict):
        def __init__(self, ent, name, data=None, changedcallback=None, default=None):
            ...
            super(NetworkDefaultDict, self).__init__(ent, name, data)
