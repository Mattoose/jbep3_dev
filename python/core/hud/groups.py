...
class GroupButton(AbilityButton):
    def __init__(self, parent, text, groupnumber, controlpanel):
        super(GroupButton, self).__init__(parent, text)
    ...
    def OnCursorEntered(self):
        super(GroupButton, self).OnCursorEntered()
        self.controlpanel.OnCursorEnteredButton(self)
        
    def OnCursorExited(self):
        super(GroupButton, self).OnCursorExited()
...
class BaseHudGroups(Panel):
    ...
    def __init__(self, parent):
        super(BaseHudGroups, self).__init__(parent, "HudGroups")
    ...
    def PerformLayout(self):
        ...
        super(BaseHudGroups, self).PerformLayout()
    ...
    buttontexture = 'hud_rebels_groupbutton'
