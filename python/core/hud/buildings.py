...
class BuildQueueButton(BitmapButton):
    def __init__(self, *args, **kwargs):
        super(BuildQueueButton, self).__init__(*args, **kwargs)
    ...
    def Paint(self):
        ...
        if unit.nextcompletiontime and unit.buildtime > 0:
            ...
            if not unit.onhold:
                self.weight = (unit.nextcompletiontime-gpGlobals.curtime) / unit.buildtime
            else:
                self.weight = unit.onholdremainingtime / unit.buildtime
    ...
    def ApplySchemeSettings(self, schemeobj):
        super(BuildQueueButton, self).ApplySchemeSettings(schemeobj)
    ...
    def OnCursorEntered(self):
        super(BuildQueueButton, self).OnCursorEntered()
        self.ShowAbility()

    def OnCursorExited(self):
        super(BuildQueueButton, self).OnCursorExited()
        self.HideAbility()
...
class HudBuildQueue(Panel):
    def __init__(self, parent):
        super(HudBuildQueue, self).__init__(parent, "HudBuildQueue")
    ...
    def ApplySchemeSettings(self, schemeobj):
        super(HudBuildQueue, self).ApplySchemeSettings(schemeobj)
    ...
    def PerformLayout(self):
        ...
        super(HudBuildQueue, self).PerformLayout()
...
class HudBuildConstruction(BaseHudSingleUnit):
    def __init__(self, parent):
        super(HudBuildConstruction, self).__init__(parent, "HudBuildConstruction")

        self.constructionstate = Label(self,"Progress","Blablabla")
    ...
    def ApplySchemeSettings(self, scheme_obj):
        super(HudBuildConstruction, self).ApplySchemeSettings(scheme_obj)

        self.constructionstate.SetFgColor(Color(255,255,255,255))

    def Update(self):
        super(HudBuildConstruction, self).Update()
    ...
    def PerformLayout(self):
        super(HudBuildConstruction, self).PerformLayout()
