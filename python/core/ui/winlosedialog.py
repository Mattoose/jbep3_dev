...
class WinLoseDialog(Panel):
    def __init__(self, winners, losers, iswinner):
        super(WinLoseDialog, self).__init__(GetClientMode().GetViewport(), "WinLoseDialog")
    ...
    def ApplySchemeSettings(self, schemeobj):
        super(WinLoseDialog, self).ApplySchemeSettings(schemeobj)
        ...
        self.winners.SetFont(hfontsmall)
        self.losers.SetFont(hfontsmall)
        
    def PerformLayout(self):
        super(WinLoseDialog, self).PerformLayout()
