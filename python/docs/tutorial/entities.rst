...
This entity uses :class:`entities.CPointEntity` as baseclass, which is a pointed-size server 
...
Networking
============================
You can network an entity in Pyton by simply adding the additional argument ``networked=True``
...
in the fog of war will not be transmitted to the player (and is thus
not created yet).
