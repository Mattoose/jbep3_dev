...
var menu_options = {
	...
	//"testserver1":[ "JOIN TEST SERVER #1", "Join Test Server #1 (jaykinbacon.co.uk)", true, false, false ],
	//"testserver2":[ "JOIN TEST SERVER #2", "Join Test Server #2 (www.natroxbox.com)", true, false, false ],
	"findservers":[ "FIND SERVERS (PLACEHOLDER)", "Find servers.", true, false, false ],
	"createserver":[ "CREATE SERVER (PLACEHOLDER)", "Create a local or internet server.", true, false, false ],
